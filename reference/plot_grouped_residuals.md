...
Plot each year-by-group mean normal-score rank residual around zero,
using exactly the same calculation as
...
This is a grouped PIT diagnostic, not a residual-implied effect. For an
effect-scale adjustment use
...
This calculation does not add residuals to year coefficients.
