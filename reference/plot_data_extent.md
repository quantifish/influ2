...
are missing. Records with a missing \`xvar\` are excluded. Completeness
is calculated separately for each variable among the records supplied;
it is not sampling intensity, measurement accuracy, or the proportion of
