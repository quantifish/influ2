...
colMeans(r2) # bayes_R2 for the three model runs
```
...
plot_compare(fits = fits, labels = c("linear", "poly", "spline", "random-effect", "fixed-effect"), year = "Year")
```
...
```{r echo=TRUE, fig.height=6, fig.width=6, message=FALSE, fig.cap = "Residuals and a loess smoother by year."}
...
```{r echo=TRUE, fig.height=6, fig.width=6, message=FALSE, fig.cap = "Simulating from a lognormal distribution and comparing with table values."}
