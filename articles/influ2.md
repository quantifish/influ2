...
horizontal for both fixed and random effects. When there are many levels
(for example, vessels), both panels label the same selection of at most
20 levels, including the first and last. Overlap protection can omit
additional labels on narrow outputs. All coefficients and bubbles remain
plotted.
